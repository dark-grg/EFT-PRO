    ...
    const prompt = `\u0627\u0641\u062D\u0635 \u0644\u0642\u0637\u0629 \u0634\u0627\u0634\u0629 \u0627\u0644\u062A\u0634\u0643\u064A\u0644\u0629 \u0628\u0639\u0646\u0627\u064A\u0629 \u062A\u0627\u0645\u0629 \u0648\u0623\u0631\u062C\u0639 \u0643\u0627\u0626\u0646 JSON \u0628\u0627\u0644\u0647\u064A\u0643\u0644 \u0627\u0644\u062A\u0627\u0644\u064A:
{
  ...
  "detectedPlayers": [
    ...
    if (!isFormationScreenshot) {
      ...
      if (typeof canonicalResponse.tacticalRating !== "number" || !Number.isFinite(canonicalResponse.tacticalRating) || canonicalResponse.tacticalRating <= 0 || canonicalResponse.tacticalRating > 100) {
        const ratedPlayers = detectedPlayers.filter(
          (p) => typeof p?.rating === "number" && Number.isFinite(p.rating) && p.rating > 0 && p.rating <= 120
        );
        if (ratedPlayers.length >= 5) {
          const avg = ratedPlayers.reduce((acc, p) => acc + p.rating, 0) / ratedPlayers.length;
